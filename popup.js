...
// Dock effect — source: https://codepen.io/GreenSock/pen/PwNeKZy
const icons = document.querySelectorAll('.nav-wrapper-bottom button');
const dock = document.querySelector('.nav-wrapper-bottom');
...
gsap.set(icons, { transformOrigin: '50% 120%' });
